      ...
      <div className="container mx-auto pt-24 font-semibold">
        ...
        <div className="card my-3">
          ...
          <div className="card-body">
            ...
            <p className="card-text">Input - {ques1i}</p>
            <p className="card-text">Output - {ques1o}</p>
          </div>
        </div>
        ...
        <div className="card my-3">
          ...
          <div className="card-body">
            ...
            <p className="card-text">Input - {ques2i}</p>
            <p className="card-text">Output - {ques2o}</p>
          </div>
        </div>
        <button className="rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white hover:bg-indigo-500 ">
          Solve Q2
        ...
        <div className="card my-3">
          ...
          <div className="card-body">
            ...
            <p className="card-text">Input - {ques3i}</p>
            <p className="card-text">Output - {ques3o}</p>
          </div>
        </div>
